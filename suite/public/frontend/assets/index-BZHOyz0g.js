import{E as e,O as t,S as n,X as r,Z as i,b as a,i as o,q as s,ut as c,y as l}from"./vue.runtime.esm-bundler-DwZq-8QY.js";import{t as u}from"./pinia-x1rPZ1th.js";import{n as d}from"./config-DgUKouBw.js";import{t as f}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as p}from"./pageMeta-ChWjEece.js";import{t as m}from"./frappeRequest-DuQ_My8u.js";import{s as h,t as g}from"./session-Cqj865AW.js";import{t as _}from"./router-B3xLXFzX.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var v=`<?xml version="1.0" encoding="utf-8"?>
...
`,y={install(e){let t=document.createElement(`div`);t.id=`lucide-sprite`,t.style.display=`none`,t.innerHTML=v,document.body.prepend(t)}},b={},x={class:`flex h-screen flex-col bg-surface-base`},S={class:`min-h-0 flex-1 overflow-auto`};function C(e,t){return s(),n(`div`,x,[l(`main`,S,[r(e.$slots,`default`)])])}var w=f(b,[[`render`,C]]),T=t({__name:`App`,setup(t){return(t,n)=>{let r=i(`router-view`);return s(),a(w,null,{default:c(()=>[e(r)]),_:1})}}});function E(){d(`resourceFetcher`,m)}function D(e,t){let n=(window.translatedMessages||{})[e]||e;return/{\d+}/.test(n)&&Array.isArray(t)?n.replace(/{(\d+)}/g,(e,n)=>{let r=t[Number(n)];return r===void 0?e:String(r)}):n}var O={install(e){e.config.globalProperties.__=D,window.__=D}};E(),g()&&h.fetch();var k=o(T);k.use(u()),k.use(_),k.use(p),k.use(y),k.use(O),_.isReady().then(()=>{k.mount(`#app`)});