const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/esm-dPI9B3WR.js","assets/rolldown-runtime-C0FnF6B9.js"])))=>i.map(i=>d[i]);
import{D as e,St as t,_ as n,b as r,k as i,mt as a,qt as o,v as s,xt as c}from"./runtime-core.esm-bundler-CaODJcyn.js";import{i as l}from"./runtime-dom.esm-bundler-CngAXjEY.js";import{t as u}from"./pinia-BoM1sIFu.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as f}from"./preload-helper-z1L8cojz.js";import{n as p,u as m}from"./session-DgDcMotU.js";import{t as h}from"./router-D0elmlUt.js";import{n as g}from"./translation-3RQ0-Kro.js";import{t as _}from"./config-BIKqku1z.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var v=`<?xml version="1.0" encoding="utf-8"?>
...
`,y={install(e){let t=document.createElement(`div`);t.id=`lucide-sprite`,t.style.display=`none`,t.innerHTML=v,document.body.prepend(t)}},b={},x={class:`flex h-screen flex-col bg-surface-base`},S={class:`min-h-0 flex-1 overflow-auto`};function C(e,t){return a(),r(`div`,x,[n(`main`,S,[c(e.$slots,`default`)])])}var w=d(b,[[`render`,C]]),T=i({__name:`App`,setup(n){return(n,r)=>{let i=t(`router-view`);return a(),s(w,null,{default:o(()=>[e(i)]),_:1})}}});async function E(e,t){if(window.sentry_dsn)try{let n=await f(()=>import(`./esm-dPI9B3WR.js`),__vite__mapDeps([0,1]));n.init({app:e,dsn:window.sentry_dsn,environment:window.sentry_environment,release:window.sentry_release,sampleRate:1,integrations:[n.browserTracingIntegration({router:t}),n.replayIntegration({maskAllText:!0,blockAllMedia:!0})],tracesSampleRate:0,replaysSessionSampleRate:0,replaysOnErrorSampleRate:1,initialScope:{user:{id:window.site_name},tags:{frappe_user:p()??`Guest`}},beforeSend(e,t){let n=t.originalException;if(n&&typeof n==`object`){let e=n,t=e.exc_type??e.excType;if(t===`PermissionError`||t===`ValidationError`)return null}return(n instanceof Error?n.stack:``)?.includes(`frappe.throw`)?null:e}})}catch(e){console.warn(`Failed to initialize error tracking`,e)}}_(),p()&&m.fetch();var D=l(T);await E(D,h),D.use(u()),D.use(h),D.use(y),D.use(g),h.isReady().then(()=>{D.mount(`#app`)});