  ...
  >
    ...
    <template #content>
      ...
      <div class="flex justify-center mb-4">
        <div
          class="w-96 h-auto aspect-video bg-gray-900 rounded-lg overflow-hidden shadow-sm relative"
        >
          <video
            ref="videoPreviewRef"
            autoplay
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-4 gap-3">
          <div
            v-for="option in allBackgroundOptionsTyped"
            :key="option.name"
          ...
          >
            <div class="aspect-video bg-gray-100 relative">
              ...
              <!-- Selected indicator -->
              <div
                v-if="selectedBackgroundOption === option.name"
              ...
              <div
                ...
                @click.stop="handleDeleteCustomImage(option.name)"
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            <p class="text-sm text-yellow-800">
              ...
              Enabling background effects may slow down your computer, especially on older devices.
            </p>
          </div>
        </div>
      </div>
