...
export interface ParticipantStore {
  ...
  updateParticipant: (participantId: string, updates: Record<string, unknown>) => void
...
export const useParticipantStore = defineStore('meet-participant', () => {
  ...
  function updateParticipant(participantId: string, updates: Record<string, unknown>) {
    const participant = participants.value[participantId] as Record<string, unknown> | undefined
    if (participant) {
