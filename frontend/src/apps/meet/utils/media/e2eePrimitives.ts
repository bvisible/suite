...
export const INFO_FRAME_AT = (senderId: number, mediaType: string, generation: number): string =>
...
export const INFO_ENVELOPE_CONTEXT = (meetingId: string, keyVersion: number): string =>
