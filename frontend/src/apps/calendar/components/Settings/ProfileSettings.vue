...
import ChangePasswordModal from '@/apps/calendar/components/Modals/ChangePasswordModal.vue'
import EditPhotoModal from '@/apps/calendar/components/Modals/EditPhotoModal.vue'
