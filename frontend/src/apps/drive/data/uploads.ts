...
export const uploadsInProgress = computed(() => uploads.value.filter(u => !u.completed && !u.error))
export const uploadsCompleted = computed(() => uploads.value.filter(u => u.completed && !u.error))
